...
turtles_msgs__msg__Target__init(turtles_msgs__msg__Target * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->target)) {
    turtles_msgs__msg__Target__fini(msg);
    return false;
  }
  return true;
}
...
turtles_msgs__msg__Target__create()
{
  ...
  turtles_msgs__msg__Target * msg = (turtles_msgs__msg__Target *)allocator.allocate(sizeof(turtles_msgs__msg__Target), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(turtles_msgs__msg__Target));
  bool success = turtles_msgs__msg__Target__init(msg);
  if (!success) {
...
turtles_msgs__msg__Target__Sequence__init(turtles_msgs__msg__Target__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  turtles_msgs__msg__Target * data = NULL;

  if (size) {
    data = (turtles_msgs__msg__Target *)allocator.zero_allocate(size, sizeof(turtles_msgs__msg__Target), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = turtles_msgs__msg__Target__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        turtles_msgs__msg__Target__fini(&data[i - 1]);
      }
...
turtles_msgs__msg__Target__Sequence__fini(turtles_msgs__msg__Target__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      turtles_msgs__msg__Target__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  turtles_msgs__msg__Target__Sequence * array = (turtles_msgs__msg__Target__Sequence *)allocator.allocate(sizeof(turtles_msgs__msg__Target__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = turtles_msgs__msg__Target__Sequence__init(array, size);
  if (!success) {
...
turtles_msgs__msg__Target__Sequence__destroy(turtles_msgs__msg__Target__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    turtles_msgs__msg__Target__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
turtles_msgs__msg__Target__Sequence__are_equal(const turtles_msgs__msg__Target__Sequence * lhs, const turtles_msgs__msg__Target__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!turtles_msgs__msg__Target__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  turtles_msgs__msg__Target__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(turtles_msgs__msg__Target);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    turtles_msgs__msg__Target * data =
      (turtles_msgs__msg__Target *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!turtles_msgs__msg__Target__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          turtles_msgs__msg__Target__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!turtles_msgs__msg__Target__copy(
